...
2. Verify the PR satisfies the linked issue's acceptance criteria.
...
Token budget matters: no narration, short commit message if you commit, short summary/comments (say the finding, skip the preamble).
